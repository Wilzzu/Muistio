...
const defaultButtonStyles = {
	...
	main: "h-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-md sm:rounded-lg bg-gradient-radial from-transparent bg-primary to-primary/60 hover:bg-primary/50 duration-200 text-xs sm:text-sm font-semibold disabled:opacity-50 disabled:pointer-events-none",
};
