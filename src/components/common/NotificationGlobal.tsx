					...
					<AnimatePresence mode="wait" onExitComplete={() => !isVisible && setShowPortal(false)}>
						{isVisible && (
							...
							<motion.div
								...
								className={cn(
									"bg-gradient-to-br from-[#5AB7FF] via-[#0794FF] to-[#5AB7FF] p-[2px] rounded-[10px] sm:rounded-[14px] shadow-accent/30 shadow-centered-sm",
									{ "from-red-400/80 via-red-500/80 to-red-400/80": warning }
								)}>
								{/* Content */}
								<div
									className={cn(
										"p-3 px-6 bg-gradient-radial from-[#077bff] from-40% to-accent text-xs sm:text-sm font-semibold drop-shadow-md rounded-lg sm:rounded-xl",
										{
